...
<html lang="es">
  <head>
    ...
    <script src="validarPhone.js"></script>
...
define("DB_PASSWORD", 'h5CU<q6UndRz#r]<');
define("DB_NAME", 'taller_software');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'archivos-backup'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-taller_software-20200907_223948.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
